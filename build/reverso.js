...
var _damienklinnert$elm_spinner$Spinner$outerStyle = function (cfg) {
	return _elm_lang$html$Html_Attributes$style(
		A2(
			...
			cfg.hwaccel ? _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'transform', _1: 'translate3d(0px, 0px, 0px)'}
				]) : _elm_lang$core$Native_List.fromArray(
				[])));
};
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {lines: a, length: b, width: c, radius: d, scale: e, corners: f, opacity: g, rotate: h, direction: i, speed: j, trail: k, translateX: l, translateY: m, shadow: n, hwaccel: o};
														};
													};
												};
											};
...
var _damienklinnert$elm_spinner$Spinner$defaultConfig = {lines: 13, length: 28, width: 14, radius: 42, scale: 1, corners: 1, opacity: 0.25, rotate: 0, direction: _damienklinnert$elm_spinner$Spinner$Clockwise, speed: 1, trail: 60, translateX: 50, translateY: 50, shadow: true, hwaccel: false};
var _damienklinnert$elm_spinner$Spinner$barStyles = F3(
	function (cfg, time, n) {
		var borderRadius = cfg.corners * cfg.width;
		...
		return _elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(cfg.width * cfg.scale),
						'px')
				},
					{
					ctor: '_Tuple2',
					...
					_1: A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString((cfg.length * cfg.scale) + cfg.width),
							'px'))
				},
					{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
					{ctor: '_Tuple2', _0: 'transform-origin', _1: 'left'},
					{
					ctor: '_Tuple2',
					_0: 'transform',
					_1: A2(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(cfg.radius * cfg.scale),
									'px, 0px)'))))
				},
					{
					ctor: '_Tuple2',
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(borderRadius * cfg.scale),
						'px')
				},
					{ctor: '_Tuple2', _0: 'opacity', _1: baseLinedOpacity},
					{
					ctor: '_Tuple2',
					_0: 'box-shadow',
			...
			A2(
				...
				function (i) {
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_damienklinnert$elm_spinner$Spinner$outerStyle(cfg)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A3(_damienklinnert$elm_spinner$Spinner$barStyles, cfg, _p4._0, i)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]));
				},
				_elm_lang$core$Native_List.range(0, cfg.lines - 1)));
	});
...
var _user$project$Styles$colors = {grey: '#666', purple: '#9a5ea7', red: '#c55353', green: '#5ea766'};

var _user$project$TranslationList$styles = {
	container: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'font-size', _1: '18px'},
			{ctor: '_Tuple2', _0: 'color', _1: '#333'},
			{ctor: '_Tuple2', _0: 'margin-bottom', _1: '10px'}
		]),
	originalText: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin-bottom', _1: '20px'}
		]),
	diffContainer: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background-color', _1: '#eee'},
			{ctor: '_Tuple2', _0: 'padding', _1: '20px'}
		]),
	partsSeparator: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'height', _1: '10px'}
		]),
	buttonCheck: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin-top', _1: '20px'},
			{ctor: '_Tuple2', _0: 'font-size', _1: '14px'},
			{ctor: '_Tuple2', _0: 'height', _1: 'auto'},
			{ctor: '_Tuple2', _0: 'background-color', _1: '#2b4564'},
	...
	guess: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '100%'},
			{ctor: '_Tuple2', _0: 'font-size', _1: '18px'},
			{ctor: '_Tuple2', _0: 'padding', _1: '6px'},
			{ctor: '_Tuple2', _0: 'border-radius', _1: '3px'},
			{ctor: '_Tuple2', _0: 'border', _1: '1px solid #333'},
			{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'}
		]),
	grey: _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'color',
			_1: function (_) {
				return _.grey;
			}(_user$project$Styles$colors)
		}
		]),
	red: _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'color',
	...
	green: _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'color',
	...
	purple: _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'color',
...
var _user$project$TranslationList$diff = F2(
	function (str1, str2) {
		var viewTarget = function (part) {
			var _p0 = part;
			switch (_p0.ctor) {
				case 'NoChange':
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.grey)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				case 'Changed':
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.purple)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				case 'Added':
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.green)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_p0._0)
			...
			switch (_p1.ctor) {
				...
				default:
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.red)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_p1._0)
		...
		var parts = A2(_avh4$elm_diff$Diff$diffChars, str1, str2);
		var part1 = _elm_lang$core$String$isEmpty(str1) ? _elm_lang$core$Native_List.fromArray(
			[]) : A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$map, viewSource, parts),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.partsSeparator)
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
				]));
		var part2 = A2(_elm_lang$core$List$map, viewTarget, parts);
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(_elm_lang$core$Basics_ops['++'], part1, part2));
	});
var _user$project$TranslationList$setChecked = function (translation) {
	var state = translation.state;
	var state$ = _elm_lang$core$Native_Utils.update(
		state,
		{checked: true});
...
var _user$project$TranslationList$updateGuess = F2(
	function (guess, translation) {
		var state = translation.state;
		var state$ = _elm_lang$core$Native_Utils.update(
			state,
			{guess: guess});
...
var _user$project$TranslationList$updateCurrent = F2(
	function ($function, model) {
		var _p2 = model.unseen;
		if (_p2.ctor === '::') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
...
var _user$project$TranslationList$isEmpty = function (model) {
	return _elm_lang$core$List$isEmpty(model.seen) && _elm_lang$core$List$isEmpty(model.unseen);
};
var _user$project$TranslationList$current = function (model) {
	return _elm_lang$core$List$head(model.unseen);
};
var _user$project$TranslationList$initialTranslationState = {guess: '', checked: false};
var _user$project$TranslationList$Translation = F3(
	function (a, b, c) {
		return {source: a, target: b, state: c};
	});
var _user$project$TranslationList$TranslationState = F2(
	function (a, b) {
		return {guess: a, checked: b};
	});
var _user$project$TranslationList$Model = F2(
	function (a, b) {
		return {seen: a, unseen: b};
	});
var _user$project$TranslationList$EnterPressed = {ctor: 'EnterPressed'};
var _user$project$TranslationList$Next = {ctor: 'Next'};
var _user$project$TranslationList$CheckGuess = {ctor: 'CheckGuess'};
var _user$project$TranslationList$UpdateGuess = function (a) {
	return {ctor: 'UpdateGuess', _0: a};
};
var _user$project$TranslationList$viewTranslation = function (translation) {
	var checked = translation.state.checked;
	var content = checked ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.diffContainer)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_user$project$TranslationList$diff, translation.state.guess, translation.target)
			])) : A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('guess'),
						_elm_lang$html$Html_Attributes$value(translation.state.guess),
						_elm_lang$html$Html_Events$onInput(_user$project$TranslationList$UpdateGuess),
						_elm_lang$html$Html_Attributes$placeholder('Guess'),
						_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.guess)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
	var checkOrNextButton = checked ? A2(
		_elm_lang$html$Html$button,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.buttonCheck),
				_elm_lang$html$Html_Events$onClick(_user$project$TranslationList$Next)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.buttonCheck),
				_elm_lang$html$Html_Events$onClick(_user$project$TranslationList$CheckGuess)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.container)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(_user$project$TranslationList$styles.originalText)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(translation.source)
							])),
						content,
						checkOrNextButton
					]))
...
var _user$project$TranslationList$view = function (model) {
	var _p3 = _user$project$TranslationList$current(model);
	if (_p3.ctor === 'Just') {
		return _user$project$TranslationList$viewTranslation(_p3._0);
	} else {
		var content = _user$project$TranslationList$isEmpty(model) ? 'No results. Try something else!' : 'That\'s it. Try a new word or phrase!';
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
...
var _user$project$TranslationList$NoOp = {ctor: 'NoOp'};
var _user$project$TranslationList$FocusGuess = {ctor: 'FocusGuess'};
var _user$project$TranslationList$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p4 = msg;
			switch (_p4.ctor) {
				case 'UpdateGuess':
					return {
						ctor: '_Tuple2',
						_0: A2(
							_user$project$TranslationList$updateCurrent,
							_user$project$TranslationList$updateGuess(_p4._0),
							model),
						_1: _user$project$TranslationList$NoOp
					};
				case 'CheckGuess':
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$TranslationList$updateCurrent, _user$project$TranslationList$setChecked, model),
						_1: _user$project$TranslationList$NoOp
					};
				case 'Next':
					var _p5 = model.unseen;
					if (_p5.ctor === '::') {
						return {
							ctor: '_Tuple2',
							...
							_1: _user$project$TranslationList$FocusGuess
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _user$project$TranslationList$NoOp};
					}
				default:
					var _p6 = _user$project$TranslationList$current(model);
					if (_p6.ctor === 'Just') {
						if (_p6._0.state.checked) {
							var _v7 = _user$project$TranslationList$Next,
								_v8 = model;
							msg = _v7;
							model = _v8;
							continue update;
						} else {
							var _v9 = _user$project$TranslationList$CheckGuess,
								_v10 = model;
							msg = _v9;
							model = _v10;
							continue update;
...
var _user$project$Reverso$toTranslationList = function (list) {
	var toTranslation = function (pair) {
		return A3(
			_user$project$TranslationList$Translation,
			_elm_lang$core$Basics$fst(pair),
			_elm_lang$core$Basics$snd(pair),
			_user$project$TranslationList$initialTranslationState);
	};
	return A2(
		_user$project$TranslationList$Model,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, toTranslation, list));
};
var _user$project$Reverso$decoder = _elm_lang$core$Json_Decode$list(
	A3(
		...
		_elm_lang$core$Json_Decode$string,
		_elm_lang$core$Json_Decode$string));
var _user$project$Reverso$url = F3(
	function (from, to, word) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'https://runkit.io/capicue/reverso/branches/master?from=',
			A2(
				_elm_lang$core$Basics_ops['++'],
				from,
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						to,
						A2(_elm_lang$core$Basics_ops['++'], '&word=', word)))));
	});
var _user$project$Reverso$examples = F3(
	function (from, to, word) {
		return A2(
			_elm_lang$core$Task$map,
			_user$project$Reverso$toTranslationList,
			A2(
				_evancz$elm_http$Http$fromJson,
				_user$project$Reverso$decoder,
				A2(
					_evancz$elm_http$Http$send,
					_evancz$elm_http$Http$defaultSettings,
					{
						verb: 'GET',
						url: A3(_user$project$Reverso$url, from, to, word),
						headers: _elm_lang$core$Native_List.fromArray(
							[]),
						body: _evancz$elm_http$Http$string('')
					})));
	});
var _user$project$Reverso$languages = _elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$styles = {
	body: _elm_lang$core$Native_List.fromArray(
		[
			...
			{ctor: '_Tuple2', _0: 'max-width', _1: '800px'},
			{ctor: '_Tuple2', _0: 'color', _1: '#2b4564'}
		]),
	container: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'height', _1: '100%'},
	...
	content: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'padding', _1: '60px 10px'}
		]),
	title: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
			{ctor: '_Tuple2', _0: 'font-size', _1: '40px'},
			{ctor: '_Tuple2', _0: 'margin-bottom', _1: '80px'},
			{ctor: '_Tuple2', _0: 'font-weight', _1: 'bold'}
		]),
	formWord: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'height', _1: '36px'},
			{ctor: '_Tuple2', _0: 'overflow', _1: 'hidden'}
		]),
	selectContainer: _elm_lang$core$Native_List.fromArray(
		[
	...
	select: _elm_lang$core$Native_List.fromArray(
		[
	...
	wordContainer: _elm_lang$core$Native_List.fromArray(
		[
	...
	word: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'border', _1: '1px solid #aaa'},
			...
			{ctor: '_Tuple2', _0: 'font-size', _1: '16px'},
			{ctor: '_Tuple2', _0: 'height', _1: '35px'},
			{ctor: '_Tuple2', _0: 'padding', _1: '0px 6px'},
			{ctor: '_Tuple2', _0: 'width', _1: '100%'}
		]),
	searchContainer: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '20%'},
			{ctor: '_Tuple2', _0: 'display', _1: 'inline-block'},
			{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
	...
	buttonSearch: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background-color', _1: '#2b4564'},
			{ctor: '_Tuple2', _0: 'border', _1: '1px solid black'},
			{ctor: '_Tuple2', _0: 'border-radius', _1: '3px'},
	...
	translationContainer: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin', _1: '50px 0 0 0'}
		]),
	footer: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
	...
	footerLink: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'text-decoration', _1: 'none'},
			{ctor: '_Tuple2', _0: 'color', _1: '#006ea6'}
		])
};
var _user$project$Main$languageOption = function (lang) {
	return A2(
		_elm_lang$html$Html$option,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$value(lang)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(lang)
			]));
};
var _user$project$Main$initialModel = {from: '', to: '', word: '', list: _krisajenkins$remotedata$RemoteData$NotAsked, spinner: _damienklinnert$elm_spinner$Spinner$init};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$focusGuess = _elm_lang$core$Native_Platform.outgoingPort(
	'focusGuess',
	function (v) {
		return null;
	});
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {from: a, to: b, word: c, list: d, spinner: e};
	});
var _user$project$Main$KeyPress = function (a) {
	return {ctor: 'KeyPress', _0: a};
};
var _user$project$Main$TranslationListMsg = function (a) {
	return {ctor: 'TranslationListMsg', _0: a};
};
var _user$project$Main$ReversoResponse = function (a) {
	return {ctor: 'ReversoResponse', _0: a};
};
		...
		switch (_p0.ctor) {
			...
			case 'SubmitWord':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{list: _krisajenkins$remotedata$RemoteData$Loading}),
					_1: A2(
						_elm_lang$core$Platform_Cmd$map,
						_user$project$Main$ReversoResponse,
						_krisajenkins$remotedata$RemoteData$asCmd(
							A3(_user$project$Reverso$examples, model.from, model.to, model.word)))
				};
			case 'ReversoResponse':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'TranslationListMsg':
				var _p1 = model.list;
				if (_p1.ctor === 'Success') {
					var _p2 = A2(_user$project$TranslationList$update, _p0._0, _p1._0);
					var list$ = _p2._0;
					var parentMsg = _p2._1;
					var cmd = _elm_lang$core$Native_Utils.eq(parentMsg, _user$project$TranslationList$FocusGuess) ? _user$project$Main$focusGuess(
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								list: _krisajenkins$remotedata$RemoteData$Success(list$)
							}),
						_1: cmd
					};
				} else {
			...
			case 'SpinnerMsg':
				var spinnerModel = A2(_damienklinnert$elm_spinner$Spinner$update, _p0._0, model.spinner);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				...
				if (_p3 === 13) {
					var _p4 = model.list;
					if (_p4.ctor === 'Success') {
						var _p5 = A2(_user$project$TranslationList$update, _user$project$TranslationList$EnterPressed, _p4._0);
						var list$ = _p5._0;
						var parentMsg = _p5._1;
						var cmd = _elm_lang$core$Native_Utils.eq(parentMsg, _user$project$TranslationList$FocusGuess) ? _user$project$Main$focusGuess(
							{ctor: '_Tuple0'}) : _elm_lang$core$Platform_Cmd$none;
						return {
							ctor: '_Tuple2',
...
var _user$project$Main$SubmitWord = {ctor: 'SubmitWord'};
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$SpinnerMsg, _damienklinnert$elm_spinner$Spinner$subscription),
				_elm_lang$keyboard$Keyboard$presses(_user$project$Main$KeyPress)
			]));
};
var _user$project$Main$UpdateWord = function (a) {
	return {ctor: 'UpdateWord', _0: a};
};
var _user$project$Main$UpdateTo = function (a) {
	return {ctor: 'UpdateTo', _0: a};
};
var _user$project$Main$UpdateFrom = function (a) {
	return {ctor: 'UpdateFrom', _0: a};
};
		...
		switch (_p6.ctor) {
			...
			case 'Loading':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_damienklinnert$elm_spinner$Spinner$view, _damienklinnert$elm_spinner$Spinner$defaultConfig, model.spinner)
						]));
			case 'Failure':
				var _p7 = _p6._0;
				switch (_p7.ctor) {
					case 'Timeout':
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('The request timed out. Please try again.')
								]));
					case 'NetworkError':
						return A2(
							_elm_lang$html$Html$div,
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Network error. Check your connection.')
								]));
					case 'UnexpectedPayload':
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Server returned an unexpected response.')
								]));
					default:
						return A2(
							_elm_lang$html$Html$div,
			...
			default:
				return A2(
					...
					_user$project$Main$TranslationListMsg,
					_user$project$TranslationList$view(_p6._0));
		}
	}();
	var spinnerConfig = function () {
		var config = _damienklinnert$elm_spinner$Spinner$defaultConfig;
		return _elm_lang$core$Native_Utils.update(
			config,
			{translateX: 0, translateY: 0});
	}();
	var buttonDisabled = _elm_lang$core$String$isEmpty(model.from) || (_elm_lang$core$String$isEmpty(model.to) || (_elm_lang$core$String$isEmpty(model.word) || _elm_lang$core$Native_Utils.eq(model.from, model.to)));
	var buttonSearchStyle = buttonDisabled ? _elm_lang$html$Html_Attributes$style(
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$styles.buttonSearch, _user$project$Main$styles.disabled)) : _elm_lang$html$Html_Attributes$style(_user$project$Main$styles.buttonSearch);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.body)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.container)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.content)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.title)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Translation Quiz')
									])),
								A2(
								_elm_lang$html$Html$form,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onSubmit(_user$project$Main$SubmitWord),
										_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.formWord)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.selectContainer)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$html$Html_Events$on,
														'change',
														A2(_elm_lang$core$Json_Decode$map, _user$project$Main$UpdateFrom, _elm_lang$html$Html_Events$targetValue)),
														_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.select)
													]),
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html$text('From Language')
																]))
														]),
													A2(_elm_lang$core$List$map, _user$project$Main$languageOption, _user$project$Reverso$languages)))
											])),
										A2(
										_elm_lang$html$Html$div,
										_elm_lang$core$Native_List.fromArray(
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$html$Html_Events$on,
														'change',
														A2(_elm_lang$core$Json_Decode$map, _user$project$Main$UpdateTo, _elm_lang$html$Html_Events$targetValue)),
														_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.select)
													]),
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html$text('To Language')
																]))
														]),
													A2(_elm_lang$core$List$map, _user$project$Main$languageOption, _user$project$Reverso$languages)))
											])),
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.wordContainer)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateWord),
														_elm_lang$html$Html_Attributes$value(model.word),
														_elm_lang$html$Html_Attributes$placeholder('Word or Phrase'),
														_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.word)
													]),
												_elm_lang$core$Native_List.fromArray(
													[]))
											])),
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.searchContainer)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.translationContainer)
									]),
								_elm_lang$core$Native_List.fromArray(
									[translationView]))
							])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.footer)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$href('https://runkit.com'),
												_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.footerLink)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('RunKit')
											])),
										_elm_lang$html$Html$text(' ('),
										A2(
										_elm_lang$html$Html$a,
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$href('https://runkit.com/capicue/reverso'),
												_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.footerLink)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$href('http://github.com/capicue/reverso'),
												_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.footerLink)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
										...
										_elm_lang$html$Html$text('). Data from '),
										A2(
										_elm_lang$html$Html$a,
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$href('http://context.reverso.net/translation/'),
												_elm_lang$html$Html_Attributes$style(_user$project$Main$styles.footerLink)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Reverso Context')
											])),
										_elm_lang$html$Html$text('.')
									]))
							]))
...
Elm['Reverso'] = Elm['Reverso'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Reverso'], 'Reverso', typeof _user$project$Reverso$main === 'undefined' ? null : _user$project$Reverso$main);
...
Elm['TranslationList'] = Elm['TranslationList'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['TranslationList'], 'TranslationList', typeof _user$project$TranslationList$main === 'undefined' ? null : _user$project$TranslationList$main);
